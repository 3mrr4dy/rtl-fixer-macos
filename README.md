...
AI explanation requires a Groq API key. Open the viewer, choose `Actions -> Set Groq API Key...`, then paste the key. The key is saved in macOS Keychain, not in the app preferences file.
